  ...
  return (
    <>
      ...
      <div className="bg-[#8b4e1f] w-full  lg:w-[500px] sm:w-full md:w-full fixed bottom-0 o py-3  z-50">
        <div
          className={`flex flex-nowrap w-[100%] items-center px-2 gap-4 overflow-x-scroll no-scrollbar text-white`}
        >
            ...
            return (
              ...
              >
                <Link to={route.path} className={`flex flex-col items-center`}>
                  ...
                  <span
                    className={`text-[12px] mt-1 transition-all duration-300 ${
                      isActive ? "text-white bg-[#8b4e1f] rounded-full" : ""
                    }`}
                  >
                    {route.label}
                  </span>
