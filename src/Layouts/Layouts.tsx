...
const Layouts = () => {
    ...
    return (
        <main className="sm:bg-[]bg-[#FAE7C7]/60 bg-cover bg-no-repeat bg-center h-[100%] sm:bg-[url('https://images.unsplash.com/photo-1695037520017-ed701ef8bd70?q=80&w=1970&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] sm:bg-fixed">
